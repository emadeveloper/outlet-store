...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } w-full bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30vh] transition-all duration-300 z-20 px-4 lg:px-[35px] `}
    >
      ...
      <div className=" flex flex-col gap-y-2 w-full overflow-y-auto overflow-x-hidden border-b relative h-[450px]">
        {cart.map((item) => {
